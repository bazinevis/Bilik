...
\enumbox{Unit}{
  ...
  COLORSTOPLIST       & = & 1 << 26 \\
  BOXSHADOWLIST       & = & 1 << 27 \\
  PPI\_UNIT           & = & INCH\textbar CM\textbar MM\textbar PT\textbar PC \\
  LENGTH              & = & PX\textbar DP\textbar VW\textbar VH\textbar EM\textbar REM\textbar PPI\_UNIT \\
  LENGTH\_PERCENT      & = & LENGTH\textbar PERCENT \\
  NUMBER\_PERCENT      & = & NUMBER\textbar PERCENT \\
  NUMBER\_LENGTH\_PERCENT & = & NUMBER\textbar LENGTH\textbar PERCENT \\
  DP\_SCALABLE\_LENGTH  & = & DP\textbar PPI\_UNIT \\
  ANGLE               & = & DEG\textbar RAD \\
  NUMERIC             & = & NUMBER\_LENGTH\_PERCENT\textbar ANGLE\textbar X \\
}{
+ operator\textbar(Units lhs, Units rhs) : Units\\
+ operator\&(Units lhs, Units rhs) : Units\\
+ Any(Units units) : bool
}
